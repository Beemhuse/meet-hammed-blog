  ...
  return (
    <footer className="bg-gray-100 dark:bg-inherit py-10">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-5">
        ...
        {/* Quick Links */}
        <div className='dark:text-[#97989F]'>
          <h3 className="text-xl dark:text-[#97989F] font-semibold mb-4">Quick Link</h3>
        ...
        {/* Categories */}
        <div>
          <h3 className="text-xl dark:text-[#97989F] font-semibold mb-4">Category</h3>
          <ul className="space-y-2 text-sm dark:text-[#97989F] text-gray-600">
        ...
        <div className="dark:bg-[#242535] bg-white p-4">
          <h3 className="text-xl font-semibold mb-4 dark:text-white text-center">Weekly Newsletter</h3>
      ...
      <div className="border-t border-gray-200 mt-8 pt-6 text-center">
        <p className="text-sm text-gray-600">MeetHammed &copy; by Bright 2025. All Rights Reserved.</p>
